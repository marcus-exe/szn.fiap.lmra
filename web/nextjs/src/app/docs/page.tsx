      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow p-6 border border-gray-200 hover:shadow-lg transition-shadow">
            <h2 className="text-2xl font-semibold mb-3 text-gray-900">Migration Playbook</h2>
          ...
          <div className="bg-white rounded-lg shadow p-6 border border-gray-200 hover:shadow-lg transition-shadow">
            <h2 className="text-2xl font-semibold mb-3 text-gray-900">Architecture Decisions</h2>
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Learn More</h3>
          <p className="text-gray-700">
